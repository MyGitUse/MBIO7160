...
* Selection acts on nucelotide frequencies
  * Example question: Do the first 10 genes from the staph data come from the same multinomial?
...
computeproportions <- function(x){x/sum(x)} #make function that takes x and divides by sum of x (takes single value & divides by column or row totol depending on margin)
...
* p0 is vector of multinomial probabilities for all 10 genes
